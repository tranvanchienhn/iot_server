...
public class ThingsboardSecurityConfiguration {
    ...
    // protected static final String[] NON_TOKEN_BASED_AUTH_ENTRY_POINTS = new String[]{"/api/user","/api/user/*/*/*/activationLink1",
    // "/api/customer/**","/index.html", "/assets/**", "/static/**", "/api/noauth/**", "/webjars/**", "/api/license/**", "/api/images/public/**", "/.well-known/**"};
    protected static final String[] NON_TOKEN_BASED_AUTH_ENTRY_POINTS = new String[]{
    "/index.html", "/assets/**", "/static/**", "/api/noauth/**", "/webjars/**", "/api/license/**", "/api/images/public/**", "/.well-known/**"};
    ...
    protected JwtTokenAuthenticationProcessingFilter buildJwtTokenAuthenticationProcessingFilter() throws Exception {
        ...
        //"/api/user","/api/user/*/*/*/activationLink1","/api/customer/**",
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.headers(headers -> headers
                ...
                .authorizeHttpRequests(config -> config
                        ...
                        // .requestMatchers(HttpMethod.GET,"/api/user/*/*/*/activationLink1").permitAll() 
