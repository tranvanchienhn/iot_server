...
public interface TbUserService {
    ...
    User registerNewUser(TenantId tenantId, CustomerId customerId, User tbUser, boolean sendActivationMail, HttpServletRequest request)throws ThingsboardException;
