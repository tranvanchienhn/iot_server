...
public class ModelConstants {
    ...
    public static final String DEVICE_SHARE_TENANT_ID_PROPERTY = "tenant_id";
    public static final String DEVICE_SHARE_CUSTOMER_ID_PROPERTY = "user_id";
    public static final String DEVICE_SHARE_CREATED_TIME_PROPERTY = "created_time";
    /**
     * User constants.
     */
